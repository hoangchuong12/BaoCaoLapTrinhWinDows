...
namespace quanlydoannhanh.frm
{
    public partial class frmDatHang : Form
    {
        ...
        {
            _loaiThucAns = QLDOAN.LoaiThucAns.ToList();
        ...
        {
            _thucAns = QLDOAN.ThucAns.Where(ta => ta.MaLoaiThucAn == maLoaiThucAn).ToList();
        ...
        {
            _hoaDonHienTai = QLDOAN.HoaDons.Include("ChiTietHoaDons").Include("ChiTietHoaDons.ThucAn")
        ...
        private void EnsureHoaDonExistsForBanAn(BanAn banAn)
        {
            ...
            if (_hoaDonHienTai == null)
            {
                ...
                QLDOAN.HoaDons.Add(_hoaDonHienTai);
                QLDOAN.SaveChanges(); // Lưu hóa đơn mới vào cơ sở dữ liệu
            }
        }
        ...
        private void btnThemMon_Click(object sender, EventArgs e)
        {
            ...
            ChiTietHoaDon chiTiet = QLDOAN.ChiTietHoaDons
            ...
            else
            {
                ...
                QLDOAN.ChiTietHoaDons.Add(chiTiet);
            }
        ...
        private void btnHuyMon_Click(object sender, EventArgs e)
        {
            if (lbHoaDon.SelectedItem != null && _hoaDonHienTai != null)
            {
                ...
                {
                    QLDOAN.ChiTietHoaDons.Remove(chiTietHoaDon);
                    QLDOAN.SaveChanges();
                    LoadHoaDonBanAn();
        ...
        private void btnHuyBan_Click(object sender, EventArgs e)
        {
            if (_hoaDonHienTai != null)
            {
                QLDOAN.HoaDons.Remove(_hoaDonHienTai);
                QLDOAN.SaveChanges();
                LoadHoaDonBanAn();
            }
        }
